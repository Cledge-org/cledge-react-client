...
const BlogsPage = ({ blogInfo }) => {
  ...
  function FilterItem(props) {
    ...
    return (
      <Button
        className={`btn rounded-pill mb-3 mx-2 ${topicFilter === props.filter ? "btn-blue" : "btn-light"}`}
        onClick={() => {
              ...
              <div className="col-md-4 border-start">
                  <div className="mx-4 mt-5">
                      ...
                      <div
                          ...
                          <p>
                              Cledge uses AI and data to help you plan your path
                              ahead and give you an edge on your application.
