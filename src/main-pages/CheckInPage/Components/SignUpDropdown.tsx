...
function useOutsideAlerter(ref: unknown, handleClickOutside: { (event: any): void; (this: Document, ev: MouseEvent): any; (this: Document, ev: MouseEvent): any; }) {
  useEffect(() => {
...
export default function SignUpDropdown({
  ...
  useOutsideAlerter(wrapperRef, (event: { target: any; }) => {
    ...
    <div
      ...
      style={
        isForDashboard
          ...
          : { ...containerStyles, maxWidth: "40rem", margin: "10px" }
      }
    >
        ...
        >
          ...
          (defaultValue === "" || defaultValue?.length === 0 || !defaultValue)
            ...
            ? defaultValue instanceof Array
              ? defaultValue.reduce((prev: string, curr: string) => {
...
SignUpDropdown.defaultProps = defaultProps;
