    ...
    return(
        ...
        <div className="container-fluid  vw-100 p-0 " 
            ...
            <div className="row align-items-center m-0" id='landing-main'>
                <div className="row col-12 col-lg-6 justify-content-center landing-page-white-text mt-5 mt-lg-0 pt-5 pt-lg-0 mx-0 px-0">
                    <div className="px-5 mx-5">
                        ...
                        <button className='btn btn-lg position-sticky px-5 py-3 border-white border-2'
                        style={{
            ...
            <div className="row align-items-center justify-content-center  m-0">
                    <h2 className='col-12 col-md-8 text-center pt-5'>Partnered with the Best Technologies</h2>
                    <div className='d-flex flex-wrap align-items-center justify-content-center py-4'>
                        <Image className='px-2' src={MsftSVG} alt='Cledge partner: Microsoft'/>
                        <Image className='px-2' src={OpenAISVG} alt="Cledge partner: OpenAI"/>
                    </div>
                    <p className='col-12 col-md-8 text-center pb-5'>
                        We are part of Microsoft for Startups and have exclusive access to OpenAI Technologies. 
