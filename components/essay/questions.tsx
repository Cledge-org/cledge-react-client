...
import CardText from "../common/Card_Text";
import CardCheckIn from "../common/Card_CheckIn";
...
import DropDownTab from "../common/DropDown_Tab";
import CardTask from "../common/Card_Task";
            ...
            <div className="tab-content h-100">
              ...
              >
                {questionData
                  ...
                  .map(({ name, chunks, _id }, index) => (
                    <CardCheckIn
                      snippet={
                        <ul className="p-0 ps-3">
                          {chunks.map(({ name }, subindex) => (
                            <li key={subindex.toString()}>{name}</li>
                          ))}
                        </ul>
                      }
                      title={name}
